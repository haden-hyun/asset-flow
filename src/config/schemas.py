...
KIS_RENAME: Dict[str, Dict[str, str]] = {
    "account_situation": {
        ...
        "evlu_pfls_amt": "valuation_profit_amount",  # 평가손익금액
    },
    "exchange_rate": {
        ...
        "ovrs_nmix_prpr": "current_price",                       # 현재가격
        "stck_shrn_iscd": "product_code",                        # 종목코드
    ...
    "domestic_balance": {
        ...
        "pchs_avg_pric": "purchase_average_cost",       # 매입단가
        "hldg_qty": "holding_quantity",                 # 보유수량
        "pchs_amt": "total_purchase_amount",            # 매입금액
        "evlu_amt": "market_value",                     # 평가금액
        "prpr": "current_price",                        # 현재가격
    },
    "overseas_balance": {
        "ovrs_pdno": "product_code",                    # 종목코드
        "ovrs_item_name": "product_name",               # 종목명
        "frcr_evlu_pfls_amt": "valuation_profit_amount",  # 평가손익금액
        "evlu_pfls_rt": "valuation_profit_rate",        # 평가손익비율
        "pchs_avg_pric": "purchase_average_cost",       # 매입단가
        "ovrs_cblc_qty": "holding_quantity",            # 보유수량
        "frcr_pchs_amt1": "total_purchase_amount",      # 매입금액
        "ovrs_stck_evlu_amt": "market_value",           # 평가금액
        "now_pric2": "current_price",                   # 현재가격
...
UPBIT_RENAME: Dict[str, str] = {
    ...
    "trade_price": "current_price",       # 현재가격
    "avg_buy_price": "purchase_average_cost",  # 매입단가
}
...
class BalanceRecord(TypedDict):
    ...
    purchase_average_cost: float
    current_price: float
    total_purchase_amount: float
    market_value: float
    valuation_profit_amount: float
